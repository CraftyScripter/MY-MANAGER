      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {hasExpandedFile ? (
          ...
          <div className="flex-1 min-h-0 overflow-auto p-4 sm:p-6 lg:p-8 space-y-6">
                ...
                {store.folderPath.length > 0 ? (
                  <div>
                    ...
                    <h1 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">
                      {store.folderPath[store.folderPath.length - 1]?.name || "Leads"}
                    </h1>
                  </div>
                ) : (
                  <div>
                    <h1 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">Leads Pipeline</h1>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                      Organize folders, spreadsheet files, and manage lead records in real time
                    </p>
                  </div>
                )}
              </div>
            ...
            {store.folderItems.length === 0 && store.fileItems.length === 0 && (
