                  ...
                  <div className="flex items-start gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {currentLevel === "write" && (
                          <span className="px-1.5 py-0.5 rounded text-[9px] font-mono uppercase font-bold bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60 leading-none">
                            Read & Write
                          </span>
                        )}
                        {currentLevel === "read" && (
                          <span className="px-1.5 py-0.5 rounded text-[9px] font-mono uppercase font-bold bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-800/60 leading-none">
                            Read Only
                          </span>
                        )}
                      </div>
